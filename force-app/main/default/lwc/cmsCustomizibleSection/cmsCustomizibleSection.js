...
export default class CmsCustomizibleSection extends LightningElement {
	...
	get contentClass() {
		return `slds-col slds-var-p-vertical_${FORM_FACTOR !== 'Large' ? 'xx-large' : 'small'} slds-size_1-of-1 slds-large-size_1-of-2`;
	}

	get imageClass() {
		return `slds-col slds-var-p-around_${FORM_FACTOR !== 'Large' ? 'xx-large' : 'small'} slds-size_1-of-1 slds-large-size_1-of-2`;
	}
}
